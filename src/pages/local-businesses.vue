...
defineOptions({
  name: 'LocalBusinessesPage',
})

useHead({
  title: 'Local Business Marketing - Redline Marketing Agency',
  meta: [
    {
      name: 'description',
      content: 'Specialized digital marketing for local businesses. Drive more foot traffic, phone calls, and revenue with our local marketing expertise.',
    },
  ],
})
</script>
    ...
    <section class="section-alt-bg section-separator py-24">
      <div class="mx-auto max-w-6xl px-4">
        <div class="text-primary prose-lg mx-auto max-w-5xl prose">
          ...
          <h3 class="text-primary mb-6 text-center text-2xl font-semibold font-racing">
