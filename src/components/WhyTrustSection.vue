...
<template>
  <section class="bg-primary relative py-20">
    <img src="/doodle.png" alt="Transistor" class="absolute z-10 size-32 w-full object-contain text-blue-500 opacity-75 -bottom-[60px]">
        ...
        <div class="space-y-6">
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-muted">
                We focus on performance, not fluff.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-muted">
                We specialize in auto, service-based, and eComm businesses.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-muted">
                No jargon, no ghosting. Just real results and real support.
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="space-y-6">
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-muted">
                Every campaign is backed by insights, not hunches.
              </p>
            </div>
          </div>
          ...
          <div class="flex items-start space-x-4">
            ...
            <div>
              ...
              <p class="text-muted">
                We're in it for the long haul, not just quick wins.
              </p>
            </div>
          </div>
        </div>
